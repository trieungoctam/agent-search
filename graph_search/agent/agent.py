...
from llm import BaseAPIModel, BaseModel
from schema import ActionReturn, ActionStatusCode, AgentReturn, AgentStatusCode, ModelStatusCode

API_PREFIX = (
    "This is the subfunction for tool '{tool_name}', you can use this tool. "
    'The description of this function is: \n{description}')

META = "When tools and code are enabled, select the appropriate tool to call based on the requirement."

INTERPRETER = """You are now able to run Python code in a stateful Jupyter notebook environment. 
When you send a message containing Python code to Python, it will be executed in that environment. 
This tool is suitable for various scenarios such as data analysis or processing (including data manipulation, statistical analysis, and chart plotting), 
solving complex computational problems (like mathematical and physical problem-solving), 
programming examples (understanding programming concepts or features), 
text processing and analysis (e.g., text parsing and natural language processing), 
machine learning and data science (used for demonstrating model training and data visualization), 
as well as file operations and data import (handling files in CSV, JSON, etc. formats)."""

PLUGIN = """You can use the following tools: \n{prompt}\n If you have sufficient information, please give the answer directly. 
Avoid unnecessary tool calls! Also, be mindful of the tools you can use"""

class Internlm2Protocol:

    def __init__(
        self,
        meta_prompt: str = META,
        interpreter_prompt: str = INTERPRETER,
        plugin_prompt: str = PLUGIN,
